...
var Lightbox = (function (_Component) {
	...
	_createClass(Lightbox, [{
		...
		value: function renderFooter(caption) {
			...
			var classes = this.props.sheet.classes;
			var _images$currentImage$cornerContent = images[currentImage].cornerContent;
			var cornerContent = _images$currentImage$cornerContent === undefined ? null : _images$currentImage$cornerContent;
		...
		value: function renderImages() {
			...
			var _ref = this.state || { windowHeight: window ? window.innerHeight : 0 };
