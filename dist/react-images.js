...
var Lightbox = (function (_Component) {
	...
	_createClass(Lightbox, [{
		...
		value: function renderFooter(caption) {
			...
			var classes = this.props.sheet.classes;
			var _images$currentImage$download = images[currentImage].download;
			var download = _images$currentImage$download === undefined ? null : _images$currentImage$download;
			...
			var controlButton = download ? _react2['default'].createElement(
				'button',
				...
				_react2['default'].createElement('span', { className: 'ion-android-download' })
			) : null;
...
Lightbox.propTypes = {
	...
	images: _react.PropTypes.arrayOf(_react.PropTypes.shape({
		...
		isVideo: _react.PropTypes.bool,
		download: _react.PropTypes.func,
